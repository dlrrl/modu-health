...
const HOW_STEPS = [
  { n: "1", title: "제휴 등록", desc: "간단한 문의 후 담당자와 협의해 제휴를 완료합니다. 별도 설비 설치 없이 바로 시작할 수 있어요." },
  { n: "2", title: "회원 방문 및 체크인", desc: "모두의 헬스 회원이 앱에서 헬스장을 찾아 방문합니다. QR 하나로 체크인이 완료됩니다." },
  { n: "3", title: "이용 현황 확인", desc: "실제 방문 데이터를 바탕으로 유입과 재방문 흐름을 확인하고 운영에 참고할 수 있습니다." },
];

const EARLY_REASONS = [
  { icon: "🏆", title: "지역 내 먼저 노출", desc: "같은 지역 헬스장 중 먼저 합류한 곳이 앱 내 상단에 노출됩니다." },
  { icon: "📈", title: "서비스 성장과 함께", desc: "회원이 늘수록 방문이 늘고, 정산도 자연스럽게 늘어납니다." },
  { icon: "🤝", title: "초기 파트너 우대", desc: "정식 확장 전 합류 파트너에게는 별도 조건을 협의드립니다." },
];
...
const FAQS = [
  ...
  { q: "정산은 어떻게 되나요?", a: "월 매출의 90%를 실제 방문 비율에 따라 제휴 헬스장에 분배합니다. 방문이 많을수록 더 많이 정산됩니다." },
  { q: "지금 제휴하면 어떤 혜택이 있나요?", a: "초기 제휴 헬스장은 앱 내 우선 노출 혜택을 받습니다. 서비스가 성장할수록 먼저 합류한 헬스장이 더 많은 유입 기회를 가져갑니다." },
    ...
    <div style={{ position: "relative", borderRadius: 16, overflow: "hidden", background: "#0a1628" }}>
      <svg width="100%" viewBox="0 0 340 260" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="rgba(255,255,255,0.15)" fontSize="7" fontFamily="system-ui, sans-serif">
          ...
          <text x="214" y="44" textAnchor="middle">도봉</text>
          <text x="100" y="64" textAnchor="middle">은평</text>
          <text x="156" y="58" textAnchor="middle">성북</text>
          <text x="200" y="66" textAnchor="middle">중랑</text>
          <text x="240" y="76" textAnchor="middle">광진</text>
          <text x="100" y="90" textAnchor="middle">서대문</text>
          <text x="148" y="86" textAnchor="middle">종로</text>
          <text x="180" y="86" textAnchor="middle">동대문</text>
          <text x="84" y="115" textAnchor="middle">마포</text>
          <text x="144" y="110" textAnchor="middle">용산</text>
          <text x="200" y="108" textAnchor="middle">성동</text>
          <text x="250" y="112" textAnchor="middle">강동</text>
          <text x="72" y="130" textAnchor="middle">양천</text>
          <text x="100" y="130" textAnchor="middle">강서</text>
          <text x="222" y="130" textAnchor="middle">송파</text>
          <text x="84" y="158" textAnchor="middle">구로</text>
          <text x="114" y="160" textAnchor="middle">동작</text>
          <text x="148" y="183" textAnchor="middle">관악</text>
          <text x="182" y="186" textAnchor="middle">서초</text>
          <text x="218" y="190" textAnchor="middle">강남</text>
          <text x="72" y="160" textAnchor="middle">금천</text>
